...
class MatchesList extends Component {
                        ...
                        style={{
                            ...
                            transform:`translate(${x}px)`
                               ...
                               <div className="block_wraper">
                                <div className="block">
                                <div className="icon" style={{background:`url(/images/${data.localThmb}.png)`}}></div>
                                <div className="team">{data.local}</div>
                                <div className="team">{data.resultLocal}</div>
                                </div>
                                <div className="block">
                                <div className="icon" style={{background:`url(/images/${data.awayThmb}.png)`}}></div>
    ...
    render() {
        console.log("PORPS", this.props.matches)
        return (
            <div>
                {this.showMatches()}
            </div>
